    ...
    public class Motor
    {
        ...
        public static void Seed(DbContext dbContext)
        {
            ...
            var motorList = new[]
            {
                    ...
                    ("Honda", "Vario 125", (70000m, 90000m), new MotorImage { Front = "60a00f6a-c2f7-44bc-878d-c6d23fcb5f66.png", Rear = "fec45a1e-94bc-4cf0-9d53-5318e1079128.png", Left = "528ee71f-c9f0-4dc2-aba3-edf50a115896.png", Right = "3184910d-299f-49ef-a7ba-bc474b39d0a0.png" }),
                    ("Honda", "Vario 160", (90000m, 115000m), new MotorImage { Front = "f87baa44-4ac4-4d2b-be92-56f87ff09f0c.png", Rear = "ae5fe5d1-b610-48ce-a4eb-915cdb98628d.png", Left = "942e9d2a-2aad-4462-877d-f9f191753655.png", Right = "80aad6a5-a991-4e45-85a4-f7104ab5a9ff.png" }),
                    ("Yamaha", "NMAX 155", (105000m, 135000m), new MotorImage { Front = "748e6f16-3515-4b3f-bbb3-83b664f4205d.png", Rear = "d54d040a-d571-4747-8f6a-f13ede66a4e0.png", Left = "71c1655f-efc8-4b64-bdaa-352a9ef2b808.png", Right = "593a13c5-a268-431f-a121-7dd367e6af62.png" }),
                    ("Yamaha", "Aerox Alpha", (95000m, 120000m), new MotorImage { Front = "329cdc4f-8377-4621-8747-89587b5b50e9.png", Rear = "6a53a9a6-4def-4c8c-80e4-a76e8838d6f1.png", Left = "2f303d88-9643-4e95-ac13-de3580565c0d.png", Right = "3dec0e24-991b-4dfe-901f-ecc1b5327223.png" }),
                };

            foreach (var (brand, model, priceRange, motorImage) in motorList)
            {
